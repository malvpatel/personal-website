...
export function toggleSvgIconOn() {
	return svgWrapper(toggleIconOn());
}
export function toggleSvgIconOff() {
	return svgWrapper(toggleIconOff());
}
export function chevronDownSvgIcon() {
	return svgWrapper(chevronDownIcon());
}
export function chevronUpSvgIcon() {
	return svgWrapper(chevronUpIcon());
}
export function linkOffSvgIcon() {
	return svgWrapper(linkOffIcon());
}
export function infoSvgIcon() {
	return svgWrapper(infoIcon());
}
